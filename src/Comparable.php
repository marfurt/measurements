...
interface Comparable extends Equatable {
	 ...
	 *
	 * @return bool Return true if the receiver is greater than object, otherwise false.
	 */
	 ...
	 * @param $object The object with which to compare the receiver.
	 *
	 * @return bool Return true if the receiver is greater than or equal to object, otherwise false.
	 */
	public function isGreaterThanOrEqualTo($object);

	/**
	 * RReturns a Boolean value that indicates whether the receiver is less than another given object.
	 *
	 * @param $object The object with which to compare the receiver.
	 *
	 * @return bool Return true if the receiver is less than object, otherwise false.
	 */
	 ...
	 * @param $object The object with which to compare the receiver.
	 *
	 * @return bool Return true if the receiver is less than or equal to object, otherwise false.
	 */
	public function isLessThanOrEqualTo($object);

	/**
	 * Compare the receiver to another given object.
	 *
	 * @param $object The object with which to compare the receiver.
	 * @param callable $comparison The closure used to compare objects.
	 *
	 * @return mixed Return the result of the comparison between the receiver and the given object.
	 */
